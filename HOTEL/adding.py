...
def add_layout(hid, base_floor_number, num_floors):
    ...
    for i in range(num_floors):
        ...
        add_room(num_rooms=2, fid=fid, hid=hid, base_room_number=27, img="../static/images/inside.jpeg",room_type=RoomType.ST, number_beds=2, rate=425, balcony=YesNo.N, city_view=YesNo.N, ocean_view=YesNo.N, smoking=YesNo.N, available=Availability.A, max_guests=4, wheelchair_accessible=YesNo.N)
